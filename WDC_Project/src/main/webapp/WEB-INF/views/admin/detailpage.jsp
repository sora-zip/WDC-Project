                               ...
                               // 정상적으로 검색이 완료됐으면 
                                if (status === kakao.maps.services.Status.OK) {
                                   ...
                                   map.setCenter(coords);
                                      ...
                                      <button class="btn btn-primary"" onclick="location.href='${ pageContext.servletContext.contextPath }/admin/selectClassBycategory?currentMenu=class&ct=accept'">뒤로 가기</button>                                     
                                      </div>
                                      <div class="col-md-2" style=" height: 100px;"></div>
                                    </div>
                                    </div>
