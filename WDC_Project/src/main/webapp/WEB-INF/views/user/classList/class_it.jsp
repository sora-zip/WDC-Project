            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                <h5 class="text-uppercase mb-4">Category</h5>
                  ...
                  <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold"><a class="class-link" href="${ pageContext.servletContext.contextPath }/user/category/computer">컴퓨터 · IT</a></strong></div>
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                <c:if test="${ empty requestScope.computerClassList }">
                <p style="margin-left: 100px; font-size: 30px;">&ouml; 해당 카테고리에 등록된 클래스가 없습니다.</p>
                </c:if>
                  <!-- PRODUCT-->
                  <c:forEach  var="classList" items="${ requestScope.computerClassList }">
