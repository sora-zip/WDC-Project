    ...
    <div class="hello" style="width: 90%; margin: 10% 10% 10% 10%; display: flex;">
      ...
      <div class="container" style="width: 80%; margin-left: 10px;">
        ...
        <div class="row" style="background-color: #f5f5f5; padding: 20px 10px 10px 10px;">
          ...
          <div class="col-md-3">
            <label>
              <input type="checkbox" value=""> 커피 별도 구매
            </label>
          </div>
          <div class="col-md-3">
            <label>
        ...
        <br>
            ...
            <br><br><hr><br>
            <button onclick="location.href='t_regCourse3_scheduleAndPrice.html'">이전</button>
            <button onclick="location.href='t_regCourse5_ terms.html'">다음></button>
      </div>
    </div>
    <br>
    <br>
